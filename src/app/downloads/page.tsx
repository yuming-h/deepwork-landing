...
export default function Downloads() {
  ...
  const handleDownload = () => {
    ...
    // Mock download - simulate a delay
    setTimeout(() => {
      setIsDownloading(false);
      // Show success message or trigger actual download when ready
      alert(
        "Thanks for your interest! DeepWork AI is coming soon. We'll notify you when it's ready for download."
      );
    }, 2000);
  };
        ...
        <div className="mx-auto max-w-6xl px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center rounded-full bg-[#5E6AD2] text-white px-4 py-2 text-sm font-medium hover:opacity-90 disabled:opacity-50"
            >
        ...
        <div className="rounded-2xl border border-black/10 dark:border-white/15 p-8 bg-white/50 dark:bg-black/30">
          <div className="text-center">
            ...
            <p className="text-black/70 dark:text-white/70 mb-6">
              Latest Version (0.1.3) • Universal build for Apple Silicon and
              Intel
            </p>
